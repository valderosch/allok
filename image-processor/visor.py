...
def checkSpaces():
    ...
    # cvzone.putTextRect(img, f'Free space count: {spaces}/{len(posList)}', (50, 60), thickness=3, offset=20,
    #                    colorR=(0, 200, 0))
    print(f'Free space count: {spaces}/{len(posList)}')


while True:
    # Get image frame
    success, img = cap.read()
    # loop current video if it ends
